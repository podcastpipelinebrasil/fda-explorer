...
const PC = {
  ...
  "relacorilant": {cid:137500072,f:"C4H8BrIO",mw:278.91,logp:2,hbd:1,hba:1,smiles:"COCCC(Br)I"},
  ...
  "difamilast": {cid:135565825,f:"C56H124N4O28",mw:1301.6,logp:2.3,hbd:24,hba:32,smiles:"C[C@H](CN(C[C@@H](C)O)C[C@@H](C)O)O.C[C@H](CN(C[C@@H](C)O)C[C@@H](C)O)O.C[C@H](CN(C[C@@H](C)O)C[C@H](C)O)O.C[C@H](CN(C[C@H](C)O)C[C@H](C)O)O.CC(CO)(CO)C(=O)O.CC(CO)(CO)C(=O)O.CC(CO)(CO)C(=O)O.CC(CO)(CO)C(=O)O"},
  "milsaperidone": {cid:145068796,f:"C14H29NO4",mw:275.38,logp:3.5,hbd:0,hba:5,smiles:"CC.CCCN(CC)CCOC(=O)C(=O)OC(C)C"},
  "tradipitant": {cid:11279236,f:"C16H15F3N2O3",mw:340.3,logp:4,hbd:2,hba:7,smiles:"C1=CC=C(C=C1)C[C@@H](CO)NC2=CC(=C(C=C2)[N+](=O)[O-])C(F)(F)F"},
  ...
  "zoliflodacin": {cid:59261,f:"C15H26OS",mw:254.4,logp:4.7,hbd:1,hba:2,smiles:"CCCCCSCC(C)C(C)(C#CC(=C)C)O"},
  "sevabertinib": {cid:145490640,f:"C39H57N9O5",mw:731.9,logp:3.2,hbd:8,hba:8,smiles:"CCCCN.C/C=C\C=C(\C)/C=C.CC(C)(C(=O)NC(CC1=CN=CN1)C(=O)NC(CC2=CC3=CC=CC=C3C=C2)C(=O)NCC(=O)NCC(=O)N)N"},
  "ziftomenib": {cid:164705437,f:"C52H46N2O2",mw:730.9,logp:13.7,hbd:1,hba:4,smiles:"CCC(C)CC1(C2=CC3=CC=CC=C3C=C2C4=NC5=CC=CC=C5C=C41)CC6(C7=CC8=CC=CC=C8C=C7C9=NC1=CC=CC=C1C=C96)CC(C)C(=O)OCC"},
  "elinzanetant": {cid:135724787,f:"C6H8N6O",mw:180.17,logp:-0.9,hbd:3,hba:5,smiles:"C1=CN=C(C=N1)C(=O)N/C(=N/N)/N"},
  "nerandomilast": {cid:145051049,f:"C40H58N4",mw:594.9,logp:2.4,hbd:2,hba:4,smiles:"CC.CC.CC.C1CN(CCN(CCCN(CCN(C1)C2=CC=CC=C2)C3=CC=CC=C3)C4=CC=CC=C4)C5=CC=CC=C5"},
  "remibrutinib": {cid:134693720,f:"C8H8N4",mw:160.18,logp:0.7,hbd:2,hba:2,smiles:"C1=CC=C2C(=C1)NC(=N2)N=CN"},
  "paltusotine": {cid:135695904,f:"C29H36N4O4S",mw:536.7,logp:6.7,hbd:1,hba:8,smiles:"CCCCOC(=O)C1=C(NC2=NC(=NN2C1C3=CC(=C(C=C3)OCC4=CC=CC=C4C)OCC)SCC)C"},
  "imlunestrant": {cid:137538760,f:"C18H18N4O2S",mw:354.4,logp:2.4,hbd:2,hba:6,smiles:"C1CN(C[C@H]1O)C(=O)C2=NC(=NC3=C2SC=C3)NCC4=CC=CC=C4"},
  "rilzabrutinib": {cid:145051406,f:"C22H10S4",mw:402.6,logp:8.5,hbd:3,hba:4,smiles:"C1=CC2=C(C3=C1C4=C(C=C3)C5=C(C=C4)C6=CSC=C6S5)SC7=CSC=C27"},
  "donidalorsen": {cid:135726233,f:"C16H18N4O8",mw:394.34,logp:-1,hbd:1,hba:10,smiles:"CC(=O)OC[C@H]1[C@@H]([C@@H]([C@@H](O1)N2C=NC3=C2N=CNC3=O)OC(=O)C)OC(=O)C"},
  "brensocatib": {cid:145051405,f:"C25H30S2",mw:394.6,logp:10.1,hbd:2,hba:2,smiles:"CCCCCCC1=C2C=CC3=C(C2=CS1)C=CC4=C(SC=C34)CCCCC"},
  "zongertinib": {cid:145054382,f:"C25H24N5O6P",mw:521.5,logp:0.6,hbd:3,hba:9,smiles:"CC(C)(C1=NC=C(C=N1)C2=CC3=C(C=C2)N=C4N3[C@@H]5C[C@H]4NC(=O)C6=C5C(=CC=C6)OC)OP(=O)(O)O"},
  "dordaviprone": {cid:71726555,f:"C61H90IN15O12",mw:1352.4,logp:-0.7,hbd:15,hba:16,smiles:"C[C@H](C(=O)NCC(=O)N[C@@H](CC1=CC=CC=C1)C(=O)N[C@@H](CC(C)C)C(=O)N[C@@H](CCCN=C(N)N)C(=O)N[C@@H](CCCCN)C(=O)N[C@@H](CC2=CC=C(C=C2)I)C(=O)N3CCC[C@H]3C(=O)N[C@@H](CCCCN)C(=O)O)NC(=O)[C@H](CC4=CC=C(C=C4)O)N"},
  "aceclidine": {cid:2006,f:"C9H7N5O3",mw:233.18,logp:0.3,hbd:3,hba:6,smiles:"C1=CC(=CC(=C1)NC(=O)C(=O)O)C2=NNN=N2"},
  "sepiapterin": {cid:135430,f:"C13H11ClNO4P",mw:311.66,logp:3.3,hbd:4,hba:4,smiles:"C1=CC=C(C=C1)P(=O)(CCl)OC2=CC=C(C=C2)[N+](=O)[O-]"},
  "delgocitinib": {cid:129840478,f:"C17H13N5OS",mw:335.4,logp:2.7,hbd:1,hba:6,smiles:"C1=CC=C(C=C1)NC2=NN=C(S2)CN3C=NC4=CC=CC=C4C3=O"},
  "sebetralstat": {cid:135695905,f:"C29H36N4O4S",mw:536.7,logp:6.7,hbd:1,hba:8,smiles:"CCCCOC(=O)C1=C(NC2=NC(=NN2C1C3=CC(=C(C=C3)OCC4=CC=CC(=C4)C)OCC)SCC)C"},
  "sunvozertinib": {cid:145054383,f:"C24H20F2N4O6P-",mw:529.4,logp:2.2,hbd:1,hba:11,smiles:"CC(C)(C1=NC=C(C=N1)C2=CC3=C(C=C2)N=C4N3[C@@H]5C[C@H]4OC6=C5C(=CC=C6)OC(F)F)OP(=O)(O)[O-]"},
  "taletrectinib": {cid:145054384,f:"C27H38F2N4O2",mw:488.6,logp:2.8,hbd:3,hba:7,smiles:"CC.CCCCC1=C(C=CC(=C1)C2=CNC(=C)N=C2)NC.C/C(=C\C(=C/C=C)\OC(F)F)/C(=O)N"},
  "acoltremon": {cid:135398532,f:"C12H15N3O6Tc",mw:396.17,logp:3.1,hbd:4,hba:9,smiles:"CC1=NC=C(C(=C1O)/C=N\N(CC(=O)O)CC(=O)O)CO.[99Tc]"},
  "avutometinib": {cid:117982328,f:"C20H24N4O3S",mw:400.5,logp:3,hbd:3,hba:6,smiles:"CC(C)C1=C/C(=C\2/NNC(=S)N2C3=CC(=C(C=C3)N(C)C)OC)/C(=O)C=C1O"},
  "atrasentan": {cid:5311272,f:"C23H26F2N2O4",mw:432.5,logp:3.7,hbd:2,hba:6,smiles:"C[C@@H](C(=O)N[C@@H](C1=CC=CC=C1)C(=O)OC(C)(C)C)NC(=O)CC2=CC(=CC(=C2)F)F"},
  "gepotidacin": {cid:71262730,f:"C21H20F2N4O3S",mw:446.5,logp:3.7,hbd:2,hba:9,smiles:"C1COCCC1COC2=C(C=NC=C2)NC(=O)C3=C(SC(=N3)C4=C(C=CC=C4F)F)N"},
  "vimseltinib": {cid:145490641,f:"C40H55N5O3",mw:653.9,logp:3.5,hbd:2,hba:5,smiles:"CN(C)C1CCCCC1.CN([C@@H](CC1=CC2=CC=CC=C2C=C1)C(=O)N(C)C(CC3=CC=CC=C3)C(=O)N)C(=O)/C=C/CC4(CCC4)N"},
  "mirdametinib": {cid:134729277,f:"C57H96O12S",mw:1005.4,logp:14.6,hbd:4,hba:12,smiles:"CCCCCCCCCCCCCCCC/C=C/CC/C=C/CCCC(=O)O[C@@H](CO[C@@H]1C(C([C@@H]([C@H](O1)CS(=O)(=O)O)O)O)O)COC(=O)CCCCC/C=C/C/C=C/C/C=C/C/C=C/C/C=C/CC"},
  ...
  "treosulfan": {cid:449459,f:"C26H29NO2",mw:387.5,logp:6.8,hbd:1,hba:3,smiles:"CC/C(=C(\C1=CC=C(C=C1)O)/C2=CC=C(C=C2)OCCN(C)C)/C3=CC=CC=C3"},
  "ensartinib": {cid:44137675,f:"C22H24N4O4",mw:408.4,logp:2,hbd:2,hba:7,smiles:"CC1=CN2C(=O)C=C(N=C2C(=C1)[C@@H](C)NC3=CC=CC=C3C(=O)O)N4CCOCC4"},
  "crinecerfont": {cid:132654780,f:"C21H22N2O4",mw:366.4,logp:4.1,hbd:1,hba:4,smiles:"CC1=CC2=C(C=C1)C(CC(O2)(C)C)NC(=O)/C=C/C3=CC=C(C=C3)[N+](=O)[O-]"},
  "iomeprol": {cid:3741,f:"C18H24I3N3O9",mw:807.1,logp:-3,hbd:8,hba:9,smiles:"C(CO)N(C1=C(C(=C(C(=C1I)C(=O)NCC(CO)O)I)C(=O)NCC(CO)O)I)C(=O)CO"},
  "landiolol": {cid:123698,f:"C17H26ClNO",mw:295.8,logp:1.2,hbd:1,hba:2,smiles:"CCC1=CC=C(C=C1)C(=O)C(C)CN2CCCCC2.Cl"},
  "acoramidis": {cid:135478710,f:"C20H14N4O3",mw:358.3,logp:4.6,hbd:2,hba:6,smiles:"C1=CC=C2C(=C1)C(=C3C=CC=CC3=N2)N/N=C/C4=C(C=CC(=C4)[N+](=O)[O-])O"},
  "revumenib": {cid:134692940,f:"C19H18N4OS2",mw:382.5,logp:4.2,hbd:2,hba:6,smiles:"C1=CC=C(C=C1)CCSCC2=NN=C3N2N=C(S3)COC4=CC=CC=C4"},
  "inavolisib": {cid:134696816,f:"C21H26N6O2",mw:394.5,logp:2.8,hbd:1,hba:8,smiles:"CC1=C(C=CN=C1)N2CCCN(CC2)C3=NC4=CC(=C(C=C4C(=N3)N)OC)OC"},
  "xanomeline": {cid:60809,f:"C14H23N3OS",mw:281.42,logp:3.3,hbd:0,hba:5,smiles:"CCCCCCOC1=NSN=C1C2=CCCN(C2)C"},
  "levacetylleucine": {cid:107973,f:"C14H14NO5P",mw:307.24,logp:2.7,hbd:2,hba:5,smiles:"CCOP(=O)(C1=CC=CC=C1)OC2=CC=C(C=C2)[N+](=O)[O-]"},
  "arimoclomol": {cid:9908088,f:"C17H25FN4O3S",mw:384.5,logp:1.7,hbd:2,hba:6,smiles:"CN(C)CCCCOC1=C(C=C(C=C1)N2CC(OC2=O)CNC(=S)N)F"},
  "daprodustat": {cid:25167983,f:"C24H26F3N7O3",mw:517.5,logp:6,hbd:3,hba:12,smiles:"C1CC(CCC1CNC2=NC(=NC=C2[N+](=O)[O-])NCC3=CC=CC=C3OC(F)(F)F)NC4=CC=NC=C4"},
  "mavorixafor": {cid:56843918,f:"C21H40I2N4O2",mw:634.4,logp:4.8,hbd:2,hba:4,smiles:"C[N+]1(CCCCC1)CCC(=O)N2CCN(CC2)C(=O)C[N+]3(CCCCC3)C.[I-].[I-]"},
  "givinostat": {cid:9908089,f:"C16H20N2O5S2",mw:384.5,logp:1.1,hbd:2,hba:7,smiles:"CC1(C(N(CCS1)S(=O)(=O)C2=CC=C(C=C2)OCC#C)C(=O)NO)C"},
  ...
  "pirtobrutinib": {cid:137401900,f:"C60H40N2",mw:789.0,logp:16.2,hbd:2,hba:6,smiles:"C1=CC=C(C=C1)C2=C3C4=C(C=CC(=C4)C5=CC6=C(C=C5)N(C7=C6C=C(C=C7C8=CC=CC=C8)C9=CC=CC=C9)C1=CC=CC=C1)N(C3=C(C=C2)C1=CC=CC=C1)C1=CC=CC=C1"},
  "elacestrant": {cid:137393176,f:"C10H18O2",mw:170.25,logp:1.7,hbd:1,hba:2,smiles:"CCC1C2(C(O2)CC(O1)(C)C)C"},
  "bexagliflozin": {cid:66827586,f:"C11H13Br",mw:225.12,logp:4.4,hbd:3,hba:7,smiles:"C/C=C\C1=CC(=C(C(=C1)C)Br)C"},
  "futibatinib": {cid:134717884,f:"C36H59NO7",mw:617.9,logp:9,hbd:2,hba:7,smiles:"CCCCC/C=C/CCC(=O)OCC(COCCC(C(=O)[O-])[N+](C)(C)C)OC(=O)CCCCC/C=C/C=C/C=C/C=C/CC"},
  "repotrectinib": {cid:134679885,f:"C10H8F5NO4",mw:301.17,logp:2.8,hbd:2,hba:10,smiles:"COC1=CN=C(C(=C1C(F)F)C(=O)OC)OC(F)(F)F"},
  "zuranolone": {cid:9908090,f:"C25H20O2S",mw:384.5,logp:6,hbd:1,hba:3,smiles:"CC(=O)C1=CC=C(C=C1)C2=C(C=CS2)C3=CC=CC=C3OCC4=CC=CC=C4"},
  "leniolisib": {cid:57448015,f:"C13H16ClF3N2O3S",mw:372.79,logp:3.6,hbd:2,hba:8,smiles:"CCN1CCN(CC1)C2=C(C(=CC=C2)OS(=O)(=O)C(F)(F)F)Cl"},
  "vamorolone": {cid:9908087,f:"C22H28N2O4",mw:384.5,logp:4.3,hbd:1,hba:4,smiles:"CCC1=C(C=CC=C1OC)C(=O)NN(C(=O)C2=CC(=CC=C2)OC)C(C)(C)C"},
  "ivosidenib": {cid:135398513,f:"C8H11N5O3",mw:225.2,logp:-1.9,hbd:3,hba:5,smiles:"C1=NC2=C(N1COCCO)N=C(NC2=O)N"},
  "olutasidenib": {cid:134710939,f:"C23H31NO5",mw:401.5,logp:3,hbd:1,hba:6,smiles:"CC(C)OC1=CC=CC(=C1)CN2CCO[C@@H]([C@H]2C3=CC(=C(C=C3)OC)OC)CO"},
  "mavacamten": {cid:135565924,f:"C25H36N6O4S",mw:516.7,logp:2.8,hbd:2,hba:8,smiles:"CCCOC1=C(C=C(C=C1)S(=O)(=O)N2C[C@H](N[C@H](C2)C)C)C3=NC4=C(C(=O)N3)N(N=C4CC(C)C)C"},
  "maribavir": {cid:132519,f:"C20H28N4O4",mw:388.5,logp:0.9,hbd:5,hba:4,smiles:"CC(C)C[C@H](CC(=O)NO)C(=O)N[C@@H](CC1=CNC2=CC=CC=C21)C(=O)NC"},
  "omaveloxolone": {cid:135565925,f:"C15H16N4O4S",mw:348.4,logp:0.7,hbd:4,hba:7,smiles:"C1[C@H](N=C(S1)C2=C(C(=CC=C2)O)O)C(=O)N(CCC3=CN=CN3)O"},
  "daridorexant": {cid:135565926,f:"C18H24Br2N2",mw:428.2,logp:3.5,hbd:2,hba:2,smiles:"C[C@H](CC1=CC=C(C=C1)Br)N.C[C@H](CC1=CC=C(C=C1)Br)N"},
  "deucravacitinib": {cid:135592453,f:"C21H23N3OS",mw:365.5,logp:4.8,hbd:1,hba:4,smiles:"CC1=CC(=CC(=C1)CN=C2NC(=O)/C(=C/C3=CC=C(C=C3)N(C)C)/S2)C"},
  "lenacapavir": {cid:163325079,f:"C22H17F29O4",mw:896.3,logp:9.3,hbd:1,hba:33,smiles:"C(COCCOCCOCCO)C(C(C(C(C(C(C(C(C(C(C(C(C(C(F)(F)F)(F)F)(F)F)(F)F)(F)F)(F)F)(F)F)(F)F)(F)F)(F)F)(F)F)(F)F)(F)F)(F)F"},
  "trofinetide": {cid:57339595,f:"C20H20N6",mw:344.4,logp:4.1,hbd:3,hba:5,smiles:"CC(C1=CC=CC=C1)NC2=NC3=C(C(=N2)NCC4=CC=CC=C4)NC=N3"},
