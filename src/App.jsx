...
const PC = {
  ...
  "difamilast": {cid:57855696,f:"C23H24F2N2O5",mw:446.4,logp:4.8,hbd:1,hba:8,smiles:"CCOC1=CC=CC=C1C(=O)NCC2=COC(=N2)C3=CC(=C(C=C3)OC(F)F)OC(C)C"},
  "milsaperidone": {cid:10365268,f:"C24H29FN2O4",mw:428.5,logp:3.9,hbd:1,hba:7,smiles:"C[C@@H](C1=CC(=C(C=C1)OCCCN2CCC(CC2)C3=NOC4=C3C=CC(=C4)F)OC)O"},
  "tradipitant": {cid:9916461,f:"C28H16ClF6N5O",mw:587.9,logp:6.2,hbd:0,hba:11,smiles:"C1=CC=C(C(=C1)C(=O)C2=C(N=CC=C2)C3=C(N(N=N3)CC4=CC(=CC(=C4)C(F)(F)F)C(F)(F)F)C5=CC=NC=C5)Cl"},
  "aficamten": {cid:139331495,f:"C18H19N5O2",mw:337.4,logp:2.1,hbd:1,hba:5,smiles:"CCC1=NC(=NO1)C2=CC3=C(C=C2)[C@@H](CC3)NC(=O)C4=CN(N=C4)C"},
  "zoliflodacin": {cid:76685216,f:"C22H22FN5O7",mw:487.4,logp:1.3,hbd:2,hba:10,smiles:"C[C@@H]1CN2[C@H]([C@@H](O1)C)C3(CC4=CC5=C(C(=C42)F)ON=C5N6[C@H](COC6=O)C)C(=O)NC(=O)NC3=O"},
  "sevabertinib": {cid:155234713,f:"C24H25ClN4O5",mw:484.9,logp:2.9,hbd:3,hba:7,smiles:"COC1=C(C=CC=C1Cl)NC2=C(NC3=C2C(=O)NCC3)C4=C(C=NC=C4)OC[C@@H]5COCCO5"},
  "ziftomenib": {cid:138497449,f:"C33H42F3N9O2S2",mw:717.9,logp:5.6,hbd:2,hba:14,smiles:"CC1=C(C=CC2=C1C=C(N2C[C@H](C)N3CCN(CC3)S(=O)(=O)C)C#N)CN4CCC(CC4)NC5=C6C=C(SC6=NC(=N5)NC)CC(F)(F)F"},
  "elinzanetant": {cid:16063568,f:"C33H35F7N4O3",mw:668.6,logp:5.9,hbd:1,hba:13,smiles:"CC1=C(C=CC(=C1)F)C2=CC(=NC=C2N(C)C(=O)C(C)(C)C3=CC(=CC(=C3)C(F)(F)F)C(F)(F)F)N4C[C@H]5COCCN5C[C@H]4CO"},
  "nerandomilast": {cid:166177189,f:"C20H25ClN6O2S",mw:449.0,logp:1.3,hbd:2,hba:9,smiles:"C1CC(C1)(CO)NC2=NC(=NC3=C2[S@](=O)CC3)N4CCC(CC4)C5=NC=C(C=N5)Cl"},
  ...
  "dordaviprone": {cid:73777259,f:"C24H26N4O",mw:386.5,logp:2.3,hbd:0,hba:3,smiles:"CC1=CC=CC=C1CN2C(=O)C3=C(CCN(C3)CC4=CC=CC=C4)N5C2=NCC5"},
  "aceclidine": {cid:1979,f:"C9H15NO2",mw:169.22,logp:0.7,hbd:0,hba:3,smiles:"CC(=O)OC1CN2CCC1CC2"},
  "sepiapterin": {cid:135398579,f:"C9H11N5O3",mw:237.22,logp:-2,hbd:4,hba:6,smiles:"C[C@@H](C(=O)C1=NC2=C(NC1)N=C(NC2=O)N)O"},
  "delgocitinib": {cid:50914062,f:"C16H18N6O",mw:310.35,logp:1.1,hbd:1,hba:5,smiles:"C[C@H]1CN([C@]12CCN(C2)C3=NC=NC4=C3C=CN4)C(=O)CC#N"},
  "sebetralstat": {cid:121365142,f:"C26H26FN5O4",mw:491.5,logp:1.3,hbd:1,hba:7,smiles:"COCC1=NN(C=C1C(=O)NCC2=NC=CC(=C2F)OC)CC3=CC=C(C=C3)CN4C=CC=CC4=O"},
  "sunvozertinib": {cid:139377809,f:"C29H35ClFN7O3",mw:584.1,logp:5,hbd:4,hba:10,smiles:"CC(C)(C1=CC(=C(C=C1NC2=NC(=NC=C2)NC3=C(C=C(C(=C3)NC(=O)C=C)N4CC[C@H](C4)N(C)C)OC)Cl)F)O"},
  "taletrectinib": {cid:72202474,f:"C23H24FN5O",mw:405.5,logp:3.8,hbd:2,hba:6,smiles:"C[C@H](COC1=CC=C(C=C1)C2=CN=C3N2N=C(C=C3)N[C@H](C)C4=CC(=CC=C4)F)N"},
  "acoltremon": {cid:11266244,f:"C18H27NO2",mw:289.4,logp:4.6,hbd:1,hba:2,smiles:"C[C@@H]1CC[C@H]([C@@H](C1)C(=O)NC2=CC=C(C=C2)OC)C(C)C"},
  "avutometinib": {cid:16719221,f:"C21H18FN5O5S",mw:471.5,logp:2,hbd:2,hba:11,smiles:"CC1=C(C(=O)OC2=C1C=CC(=C2)OC3=NC=CC=N3)CC4=C(C(=NC=C4)NS(=O)(=O)NC)F"},
  "atrasentan": {cid:159594,f:"C29H38N2O6",mw:510.6,logp:2.4,hbd:1,hba:7,smiles:"CCCCN(CCCC)C(=O)CN1C[C@@H]([C@H]([C@@H]1C2=CC=C(C=C2)OC)C(=O)O)C3=CC4=C(C=C3)OCO4"},
  "gepotidacin": {cid:25101874,f:"C24H28N6O3",mw:448.5,logp:0.1,hbd:1,hba:7,smiles:"C1CC2=CC(=NC=C2OC1)CNC3CCN(CC3)C[C@@H]4CN5C(=O)C=CC6=C5N4C(=O)C=N6"},
  "vimseltinib": {cid:86267612,f:"C23H25N7O2",mw:431.5,logp:1.5,hbd:1,hba:6,smiles:"CC1=C(C=CC(=N1)C2=CN=C(N(C2=O)C)NC(C)C)OC3=CC(=NC=C3)C4=CN(N=C4)C"},
  "mirdametinib": {cid:9826528,f:"C16H14F3IN2O4",mw:482.19,logp:3,hbd:4,hba:8,smiles:"C1=CC(=C(C=C1I)F)NC2=C(C=CC(=C2F)F)C(=O)NOC[C@@H](CO)O"},
  "suzetrigine": {cid:156445116,f:"C21H20F5N3O4",mw:473.4,logp:3,hbd:2,hba:10,smiles:"C[C@H]1[C@H]([C@@H](O[C@@]1(C)C(F)(F)F)C(=O)NC2=CC(=NC=C2)C(=O)N)C3=C(C(=C(C=C3)F)F)OC"},
  "treosulfan": {cid:9882105,f:"C6H14O8S2",mw:278.3,logp:-2.2,hbd:2,hba:8,smiles:"CS(=O)(=O)OC[C@@H]([C@H](COS(=O)(=O)C)O)O"},
  "ensartinib": {cid:56960363,f:"C26H27Cl2FN6O3",mw:561.4,logp:3.6,hbd:3,hba:8,smiles:"C[C@@H]1CN(C[C@@H](N1)C)C(=O)C2=CC=C(C=C2)NC(=O)C3=NN=C(C(=C3)O[C@H](C)C4=C(C=CC(=C4Cl)F)Cl)N"},
  "crinecerfont": {cid:5282340,f:"C27H28ClFN2OS",mw:483.0,logp:8,hbd:0,hba:5,smiles:"CC1=C(C=C(C=C1)[C@H](CC2CC2)N(CC#C)C3=NC(=C(S3)C)C4=C(C=C(C(=C4)C)OC)Cl)F"},
  "iomeprol": {cid:3731,f:"C17H22I3N3O8",mw:777.1,logp:-2.3,hbd:7,hba:8,smiles:"CN(C1=C(C(=C(C(=C1I)C(=O)NCC(CO)O)I)C(=O)NCC(CO)O)I)C(=O)CO"},
  "landiolol": {cid:114905,f:"C25H39N3O8",mw:509.6,logp:0.1,hbd:3,hba:9,smiles:"CC1(OC[C@H](O1)COC(=O)CCC2=CC=C(C=C2)OC[C@H](CNCCNC(=O)N3CCOCC3)O)C"},
  "acoramidis": {cid:71464713,f:"C15H17FN2O3",mw:292.3,logp:2.9,hbd:2,hba:5,smiles:"CC1=C(C(=NN1)C)CCCOC2=C(C=CC(=C2)C(=O)O)F"},
  "revumenib": {cid:132212657,f:"C32H47FN6O4S",mw:630.8,logp:4.3,hbd:1,hba:10,smiles:"CCN(C(C)C)C(=O)C1=C(C=CC(=C1)F)OC2=CN=CN=C2N3CC4(C3)CCN(CC4)CC5CCC(CC5)NS(=O)(=O)CC"},
  "inavolisib": {cid:124173720,f:"C18H19F2N5O4",mw:407.4,logp:1.5,hbd:2,hba:8,smiles:"C[C@@H](C(=O)N)NC1=CC2=C(C=C1)C3=NC(=CN3CCO2)N4[C@@H](COC4=O)C(F)F"},
  "xanomeline": {cid:60809,f:"C14H23N3OS",mw:281.42,logp:3.3,hbd:0,hba:5,smiles:"CCCCCCOC1=NSN=C1C2=CCCN(C2)C"},
  "levacetylleucine": {cid:70912,f:"C8H15NO3",mw:173.21,logp:0.5,hbd:2,hba:3,smiles:"CC(C)C[C@@H](C(=O)O)NC(=O)C"},
  "arimoclomol": {cid:208924,f:"C14H20ClN3O3",mw:313.78,logp:1.2,hbd:1,hba:5,smiles:"C1CCN(CC1)C[C@H](CON=C(C2=C[N+](=CC=C2)[O-])Cl)O"},
  "daprodustat": {cid:91617630,f:"C19H27N3O6",mw:393.4,logp:2.5,hbd:2,hba:6,smiles:"C1CCC(CC1)N2C(=O)C(C(=O)N(C2=O)C3CCCCC3)C(=O)NCC(=O)O"},
  "mavorixafor": {cid:11256587,f:"C21H27N5",mw:349.5,logp:2.4,hbd:2,hba:4,smiles:"C1C[C@@H](C2=C(C1)C=CC=N2)N(CCCCN)CC3=NC4=CC=CC=C4N3"},
  "givinostat": {cid:9804992,f:"C24H27N3O4",mw:421.5,logp:3.6,hbd:3,hba:5,smiles:"CCN(CC)CC1=CC2=C(C=C1)C=C(C=C2)COC(=O)NC3=CC=C(C=C3)C(=O)NO"},
  "resmetirom": {cid:15981237,f:"C17H12Cl2N6O4",mw:435.2,logp:2.7,hbd:2,hba:7,smiles:"CC(C)C1=CC(=NNC1=O)OC2=C(C=C(C=C2Cl)N3C(=O)NC(=O)C(=N3)C#N)Cl"},
  "pirtobrutinib": {cid:129269915,f:"C22H21F4N5O3",mw:479.4,logp:3.3,hbd:3,hba:9,smiles:"C[C@@H](C(F)(F)F)N1C(=C(C(=N1)C2=CC=C(C=C2)CNC(=O)C3=C(C=CC(=C3)F)OC)C(=O)N)N"},
  "elacestrant": {cid:23642301,f:"C30H38N2O2",mw:458.6,logp:6.3,hbd:2,hba:4,smiles:"CCNCCC1=CC=C(C=C1)CN(CC)C2=C(C=CC(=C2)OC)[C@@H]3CCC4=C(C3)C=CC(=C4)O"},
  "bexagliflozin": {cid:25195624,f:"C24H29ClO7",mw:464.9,logp:2.4,hbd:4,hba:7,smiles:"C1CC1OCCOC2=CC=C(C=C2)CC3=C(C=CC(=C3)[C@H]4[C@@H]([C@H]([C@@H]([C@H](O4)CO)O)O)O)Cl"},
  "futibatinib": {cid:71621331,f:"C22H22N6O3",mw:418.4,logp:2,hbd:1,hba:7,smiles:"COC1=CC(=CC(=C1)C#CC2=NN(C3=NC=NC(=C23)N)[C@H]4CCN(C4)C(=O)C=C)OC"},
  "repotrectinib": {cid:135565923,f:"C18H18FN5O2",mw:355.4,logp:2.1,hbd:2,hba:6,smiles:"C[C@H]1CNC(=O)C2=C3N=C(C=CN3N=C2)N[C@@H](C4=C(O1)C=CC(=C4)F)C"},
  "zuranolone": {cid:86294073,f:"C25H35N3O2",mw:409.6,logp:4.5,hbd:1,hba:4,smiles:"C[C@]1(CC[C@H]2[C@@H](C1)CC[C@@H]3[C@@H]2CC[C@]4([C@H]3CC[C@@H]4C(=O)CN5C=C(C=N5)C#N)C)O"},
  "leniolisib": {cid:57495353,f:"C21H25F3N6O2",mw:450.5,logp:2.5,hbd:1,hba:10,smiles:"CCC(=O)N1CC[C@@H](C1)NC2=NC=NC3=C2CN(CC3)C4=CC(=C(N=C4)OC)C(F)(F)F"},
  "vamorolone": {cid:3035000,f:"C22H28O4",mw:356.5,logp:2.7,hbd:2,hba:4,smiles:"C[C@@H]1C[C@H]2[C@@H]3CCC4=CC(=O)C=C[C@@]4(C3=CC[C@@]2([C@]1(C(=O)CO)O)C)C"},
  "ivosidenib": {cid:71657455,f:"C28H22ClF3N6O3",mw:583.0,logp:3.4,hbd:1,hba:9,smiles:"C1CC(=O)N([C@@H]1C(=O)N(C2=CC(=CN=C2)F)[C@@H](C3=CC=CC=C3Cl)C(=O)NC4CC(C4)(F)F)C5=NC=CC(=C5)C#N"},
  "olutasidenib": {cid:118955396,f:"C18H15ClN4O2",mw:354.8,logp:2.5,hbd:2,hba:4,smiles:"C[C@@H](C1=CC2=C(C=CC(=C2)Cl)NC1=O)NC3=CC=C(N(C3=O)C)C#N"},
  "mavacamten": {cid:117761397,f:"C15H19N3O2",mw:273.33,logp:2.1,hbd:2,hba:3,smiles:"C[C@@H](C1=CC=CC=C1)NC2=CC(=O)N(C(=O)N2)C(C)C"},
  "maribavir": {cid:471161,f:"C15H19Cl2N3O4",mw:376.2,logp:2.2,hbd:4,hba:6,smiles:"CC(C)NC1=NC2=CC(=C(C=C2N1[C@@H]3[C@H]([C@H]([C@@H](O3)CO)O)O)Cl)Cl"},
  "omaveloxolone": {cid:71811910,f:"C33H44F2N2O3",mw:554.7,logp:6.7,hbd:1,hba:6,smiles:"C[C@@]12CC[C@]3(CCC(C[C@H]3[C@H]1C(=O)C=C4[C@]2(CC[C@@H]5[C@@]4(C=C(C(=O)C5(C)C)C#N)C)C)(C)C)NC(=O)C(C)(F)F"},
  "daridorexant": {cid:91801202,f:"C23H23ClN6O2",mw:450.9,logp:4.1,hbd:1,hba:5,smiles:"CC1=C(C=CC2=C1N=C(N2)[C@@]3(CCCN3C(=O)C4=C(C=CC(=C4)OC)N5N=CC=N5)C)Cl"},
  "deucravacitinib": {cid:134821691,f:"C20H22N8O3",mw:425.5,logp:1.2,hbd:3,hba:8,smiles:"[2H]C([2H])([2H])NC(=O)C1=NN=C(C=C1NC2=CC=CC(=C2OC)C3=NN(C=N3)C)NC(=O)C4CC4"},
  "lenacapavir": {cid:133082658,f:"C39H32ClF10N7O5S2",mw:968.3,logp:6.4,hbd:2,hba:19,smiles:"CC(C)(C#CC1=NC(=C(C=C1)C2=C3C(=C(C=C2)Cl)C(=NN3CC(F)(F)F)NS(=O)(=O)C)[C@H](CC4=CC(=CC(=C4)F)F)NC(=O)CN5C6=C([C@H]7C[C@H]7C6(F)F)C(=N5)C(F)(F)F)S(=O)(=O)C"},
  "trofinetide": {cid:11318905,f:"C13H21N3O6",mw:315.32,logp:-3.9,hbd:4,hba:7,smiles:"C[C@]1(CCCN1C(=O)CN)C(=O)N[C@@H](CCC(=O)O)C(=O)O"},
  "sonrotoclax": {cid:149553242,f:"C49H59N7O7S",mw:890.1,logp:9.1,hbd:4,hba:11,smiles:"CC(C)C1=CC=CC=C1[C@@H]2CCCN2C3CC4(C3)CCN(CC4)C5=CC(=C(C=C5)C(=O)NS(=O)(=O)C6=CC(=C(C=C6)NCC7CCC(CC7)(C)O)[N+](=O)[O-])OC8=CN=C9C(=C8)C=CN9"},
  "vepdegestrant": {cid:134562533,f:"C45H49N5O4",mw:723.9,logp:6.4,hbd:2,hba:7,smiles:"C1CC2=C(C=CC(=C2)O)[C@H]([C@H]1C3=CC=CC=C3)C4=CC=C(C=C4)N5CCC(CC5)CN6CCN(CC6)C7=CC8=C(C=C7)C(=O)N(C8)[C@H]9CCC(=O)NC9=O"},
  "baxdrostat": {cid:71535962,f:"C22H25N3O2",mw:363.5,logp:2.2,hbd:1,hba:3,smiles:"CCC(=O)N[C@@H]1CCCC2=C1C=NC=C2C3=CC4=C(C=C3)N(C(=O)CC4)C"},
...
const RAW = {
  2026:[
    // ── Agosto 2026 ──
    {name:"Pasatru",    ing:"garetosmab-grts",          date:"2026-08-19",sponsor:"Regeneron",route:"IV",moa:"Anticorpo monoclonal totalmente humano (VelocImmune) que se liga e neutraliza a activina A, proteína que ativa de forma aberrante o receptor ACVR1 (ALK2) mutado, bloqueando a ossificação heterotópica na FOP",atc:"M09AX",desig:["OD","FT","PR"],indication:"Reduction of new heterotopic ossification and clinician-assessed disease flare-ups in adults with fibrodysplasia ossificans progressiva (FOP)"},
    {name:"Zenbexus",   ing:"iberdomide",               date:"2026-08-13",sponsor:"Bristol Myers Squibb",route:"PO",moa:"First-in-class CELMoD (cereblon E3 ligase modulator); binds cereblon and recruits the cell's degradation machinery to eliminate oncogenic transcription factors (Ikaros/Aiolos), with tighter binding and faster degradation than classic IMiDs",atc:"L04AX",desig:["AA"],indication:"Multiple myeloma, in combination with daratumumab and hyaluronidase-fihj and dexamethasone, after ≥1 prior line including a proteasome inhibitor and an immunomodulatory agent"},
    {name:"Tauklarify", ing:"florquinitau F 18",         date:"2026-08-13",sponsor:"Lantheus",route:"IV",moa:"Fluorine-18 labeled PET radiotracer (MK-6240); binds selectively to aggregated tau in neurofibrillary tangles (NFT), enabling visualization of cerebral tau pathology",atc:"V09AX",desig:[],indication:"PET imaging of the brain in adults with cognitive impairment being evaluated for Alzheimer's disease, to identify tau neurofibrillary tangle (NFT) pathology"},
    {name:"Orzeyful",   ing:"oveporexton",              date:"2026-08-05",sponsor:"Takeda",route:"PO",moa:"First oral selective orexin receptor 2 (OX2R) agonist; directly restores orexin signaling lost in narcolepsy type 1, addressing the underlying cause rather than only the symptoms",atc:"N07XX",desig:["FIC","BT","PR","OD"],indication:"Narcolepsy type 1 (narcolepsy with cataplexy) in adults"},
    {name:"Simtriyo",   ing:"centanafadine",            date:"2026-07-24",sponsor:"Otsuka",route:"PO",moa:"First-in-class triple reuptake inhibitor of norepinephrine, dopamine and serotonin (NDSRI); increases availability of all three neurotransmitters in pathways involved in attention and behavioral regulation",atc:"N06BA",desig:["FIC"],indication:"Attention-deficit/hyperactivity disorder (ADHD) in patients ≥6 years weighing ≥20 kg"},
    // ── Julho 2026 ──
...
function isBiologic(ing) {
  return /-(mab|cept|alfa|beta|gamma|deruxtecan|vedotin|wuug|szsi|hrii|hncq|tllv|kcqx|cfor|aahu|bcmm|tgvs|mrkz|irmb|lbkz|trbw|dlnk|nbln|ipdl|zbco|clzb|mtci|ulaa|eknm|gcpt|liga|dpyl|jome|actl|gmod|pvzy|vvze|vymj|vikg|grts)\b/i.test(ing) ||
    /\b(narsoplimab|sibeprenlimab|depemokimab|icotrokinra|navepegritide|pegzilarginase|tividenofusp|concizumab|linvoseltamab|garadacimab|clesrovimab|telisotuzumab|nipocalimab|penpulimab|datopotamab|pembrolizumab|plozasiran|fitusiran|vutrisiran|nedosiran|olezarsen|tofersen|insulin icodec|bulevirtide|pivekimab|veligrotug|atacicept|bevacizumab|garetosmab)\b/i.test(ing);
}
